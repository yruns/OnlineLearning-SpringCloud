...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/onlearning-plus-generator/src/main/java");
		gc.setAuthor("yruns");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://192.168.48.200:3306/xcplus_" + SERVICE_NAME
