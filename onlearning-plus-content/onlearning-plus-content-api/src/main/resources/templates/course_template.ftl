...
<div class="article-banner">
    ...
    <div class="banner-info">
        ...
        <div class="banner-rit">
            <p>
                <a href="http://www.onlearning.com/course/preview/learning.html?id=${model.courseBase.id}" target="_blank">
                                ...
                                <div class="drop-down" style="height: 260px;">
                                    <ul class="list-box">
                                        <#list firstNode.teachPlanTreeNodes as secondNode>
                                            <li><a href="http://www.onlearning.com/course/preview/learning.html?id=${model.courseBase.id}" target="_blank">${secondNode.pname!""}</a></li>
                                            <#--&chapter=${secondNode.teachplanMedia.teachplanId!""}-->
                                        </#list>
                                    </ul>
                                </div>
                            </div>
